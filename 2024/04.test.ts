...
Deno.test('countXmas', () => {
    assertEquals(countXMas(input), 2358)
})

Deno.test('topLeftToBottomRightDiagonals', () => {
    assertEquals(
        topLeftToBottomRightDiagonals(small),
        ['3', '14', '2'],
    )
})

Deno.test('bottomLeftToTopRightDiagonals', () => {
    assertEquals(
        bottomLeftToTopRightDiagonals(small),
        ['4', '32', '1'],
    )
})
